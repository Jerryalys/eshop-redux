...
function Sweatshirts () {
  return (
    ...
    <ProductList 
        ...
        description='Sweatshirts for Men Take on Dual Duty. An Activewear Staple, They Make the Cut in a Sports and Casual Context. From White to Black, Oversized to Short-Sleeved'
      />
    </>
  );
}
